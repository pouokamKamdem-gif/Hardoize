 ...
 * ║  S'adapte au thème clair/sombre (corrigé : plus de couleurs  ║
 * ║  codées en dur, tout dépend de `darkMode`).                  ║
 * ║                                                              ║
 * ║  Fonctionnalités :                                           ║
...
const GroupesScreen = () => {
  ...
  const modifierRole = (membre) => {
    Alert.alert(
      ...
      [
        { text: "Vendeur",        onPress: () => appliquerRole(membre, ROLES.VENDEUR) },
        { text: "Magasinier",     onPress: () => appliquerRole(membre, ROLES.MAGASINIER) },
        { text: "Caissier",       onPress: () => appliquerRole(membre, ROLES.CAISSIER) },
        { text: "Administrateur", onPress: () => appliquerRole(membre, ROLES.ADMIN) },
  ...
  // ── Couleurs thème (CORRIGÉ : dépend bien de darkMode) ─────
  ...
  const inputBgCouleur = darkMode ? COLORS.SURFACE_DARK : COLORS.BG_CARD_LIGHT;
  const badgeBgCouleur = darkMode ? COLORS.BG_CARD_DARK : COLORS.BG_CARD_LIGHT;
  ...
  const renderMembre = (item) => {
    ...
    return (
      <TouchableOpacity
        ...
        onLongPress={() => {
          if (
            utilisateur?.role === ROLES.PROPRIETAIRE ||
      ...
      >
        ...
        <View style={styles.membreInfo}>
          ...
          <Text style={[
            styles.membreBail,
            { color: expireBail ? COLORS.SCORE_ROUGE : textSecondaire }
          ]}>
            {expireBail
              ? "⏱ Bail expiré"
        ...
        {/* Total ventes */}
        <Text style={[styles.membreTotal, { color: COLORS.SCORE_VERT }]}>
          +0 FCFA
        </Text>
      </TouchableOpacity>
    );
  ...
  const renderGroupe = (item) => (
    ...
    >
      ...
      <View style={styles.groupeInfo}>
        ...
        <Text style={[styles.groupeDesc, { color: textSecondaire }]}>
      ...
      {/* Flèche */}
      <Text style={{ color: textSecondaire, fontSize: 20 }}>
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: bgCouleur }]}>
      ...
      />
          ...
          <View>
            ...
            <Text style={[styles.headerSub, { color: textSecondaire }]}>
              {groupeActif
      ...
      >
        ...
        {groupes.length > 0 && (
          <View style={styles.section}>
            ...
            {groupes.map((groupe) => renderGroupe(groupe))}
          </View>
        )}
          ...
          <View style={[styles.qrSection, { backgroundColor: cardCouleur }]}>
            <View style={styles.qrContainer}>
              <QRCode
                ...
                size={200}
                color={darkMode ? COLORS.BG_DARK : COLORS.BG_DARK}
            ...
            <Text style={[styles.qrSub, { color: textSecondaire }]}>
        ...
        {groupeActif && (
          <View style={[styles.whatsappSection, { backgroundColor: COLORS.ORANGE }]}>
            ...
            <TouchableOpacity
              style={[
                styles.btnWhatsapp,
                { backgroundColor: darkMode ? COLORS.BG_DARK : COLORS.BG_DARK },
        ...
        {groupeActif && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <View style={[styles.badgeEnDirect, { backgroundColor: badgeBgCouleur }]}>
                <Text style={[styles.badgeEnDirectTexte, { color: textSecondaire }]}>
                  En direct
                </Text>
              </View>
            </View>
            ...
            {membres.length === 0 ? (
              <Text style={[styles.aucunMembre, { color: textSecondaire }]}>
                Aucun vendeur connecté pour l'instant
              </Text>
            ) : (
              membres.map((membre) => renderMembre(membre))
            )}
          </View>
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContainer, { backgroundColor: cardCouleur }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={[styles.infoHeure, { color: textSecondaire }]}>
          ...
          <View style={[styles.modalContainer, { backgroundColor: cardCouleur }]}>
            {membreSelectionne && (
              <>
                ...
                <Text style={[styles.membreRoleActuel, { color: textSecondaire }]}>
